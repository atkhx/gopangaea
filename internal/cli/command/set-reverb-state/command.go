...
import (
	...
	deviceCommand "github.com/atkhx/gopangaea/internal/pkg/commands/set-reverb-state"
	"github.com/atkhx/gopangaea/internal/pkg/device"
)

const (
	CliCommand     = "set-reverb-state"
	CliDescription = "включить / выключить реверберацию"
)
