...
import (
	...
	deviceCommand "github.com/atkhx/gopangaea/internal/pkg/commands/set-presence-value"
	"github.com/atkhx/gopangaea/internal/pkg/device"
)

const (
	CliCommand     = "set-presence-value"
	CliDescription = "установить значение Presence"
)
